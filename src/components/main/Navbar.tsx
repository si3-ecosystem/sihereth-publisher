...
const Navbar: React.FC<NavbarProps> = ({ handleToggleView, screenWidth, handlePublish, loading, mode, navigate }) => {
  return (
      ...
      <div className="flex flex-1 justify-center items-center sm:items-stretch sm:justify-start">
        <div className="flex justify-center items-center w-full sm:ml-6">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex flex-col">
              <SlScreenTablet onClick={() => handleToggleView("70%")} className="relative text-xl cursor-pointer" />
              {screenWidth === "70%" && (
                <div
                  style={{
                    borderBottom: "3px solid #a020f0",
